...
docker-compose -f compose.prod.yaml exec laravel.test php artisan optimize:clear

# 3. Reconstruir caché optimizado
echo "⚡ Generando caché de producción..."
docker-compose -f compose.prod.yaml exec laravel.test php artisan optimize
