...
<head>
    ...
    <title>G.E.L.I.A. vista de pruebas</title>
...
<body class="bg-dark-900 text-dark-text min-h-screen font-sans selection:bg-blue-500 selection:text-white pb-20">
    ...
    <div class="max-w-6xl mx-auto p-6">
        ...
        <header class="flex items-center justify-between mb-8 border-b border-dark-700 pb-6">
            <div>
                ...
                <p class="text-gray-400 mt-1 text-sm font-medium">Vistas de Prueba Gelia</p>
            </div>
    ...
    <script>
        // Este bloque se queda aquí porque usa funciones de Laravel que JS externo no entiende
        window.GeliaConfig = {
            routes: {
