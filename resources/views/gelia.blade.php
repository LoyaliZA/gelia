...
@section('title', 'Aromas | Gelia Hub')
...
<header class="flex items-center justify-between mb-8 border-b border-dark-700 pb-6">
    <div>
        <h1 class="text-4xl font-extrabold text-white tracking-tight">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-aromas-main to-emerald-400">Aromas</span>
            <span class="text-lg text-dark-muted font-normal ml-2">Gelia Hub</span>
        </h1>
        <p class="text-dark-muted mt-1 text-sm font-medium">Gestión de resurtidos, clientes y operaciones contables.</p>
    </div>
...
<form id="form-principal" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
        ...
        <x-upload-area 
            id="clientes" 
            name="clientes" 
            title="4. Clientes CSV" 
            colorTheme="yellow" 
            instructions="Archivo CSV de Clientes para limpieza de base de datos." 
        />
    </div>
    ...
    <div class="mb-10">
        ...
        <div class="bg-dark-800 border border-dark-700 p-5 rounded-xl flex flex-col md:flex-row gap-6 items-center shadow-lg">
            <div class="w-full md:w-1/3">
                <p class="text-dark-muted text-sm mb-4">Limpia, corrige codificación y formatea tu base de datos de clientes.</p>
            ...
            <div class="w-full md:w-1/3 border-t md:border-t-0 md:border-l border-dark-700 pt-4 md:pt-0 md:pl-6">
                <div class="flex justify-between items-end mb-2">
                    <span class="block text-xs font-bold text-dark-muted">Columnas a exportar:</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        ...
        <div class="flex flex-col">
            <h2 class="text-xl font-bold text-white mb-5 flex items-center">
                <span class="bg-cyan-600 w-2 h-6 rounded mr-2"></span> Gastos Comprobables
            </h2>
            <div class="bg-dark-800 border border-dark-700 p-5 rounded-xl flex flex-col gap-4 shadow-lg flex-1">
                <x-upload-area 
                    id="gastos" 
                    name="archivo_gastos" 
                ...
                <button type="button" onclick="procesarSolicitud('gastos')" class="mt-auto w-full py-3 bg-green-600/20 border border-green-600/50 text-emerald-400 hover:bg-green-600 hover:text-white rounded-lg font-bold transition flex justify-center items-center gap-2">
                    Generar Gastos
                </button>
            </div>
        </div>
        ...
        <div class="flex flex-col">
            <h2 class="text-xl font-bold text-white mb-5 flex items-center">
                <span class="bg-orange-600 w-2 h-6 rounded mr-2"></span> Transacciones Bancarias
            </h2>
            <div class="bg-dark-800 border border-dark-700 p-5 rounded-xl flex flex-col gap-4 shadow-lg flex-1">
                <x-upload-area 
                    id="transacciones" 
                    ...
                    colorTheme="orange"
                    instructions="Se limpiarán las columnas no deseadas."
                />
                <button type="button" onclick="procesarSolicitud('transacciones')" class="mt-auto w-full py-3 bg-indigo-600/20 border border-indigo-600/50 text-indigo-400 hover:bg-indigo-600 hover:text-white rounded-lg font-bold transition flex justify-center items-center gap-2">
...
@push('scripts')
@vite(['resources/js/app.js', 'resources/js/aromas.js'])

<script>
    // Variables de entorno de Laravel para que JS las reconozca (Solo en este módulo)
    window.GeliaConfig = {
        routes: {
