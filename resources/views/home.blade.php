...
<div class="min-h-[80vh] flex flex-col items-center justify-center">
    ...
    <div class="text-center mb-16 flex flex-col items-center">
        <!-- Logotipo principal con animación -->
        <div class="mb-6 transform hover:scale-105 transition-transform duration-500 ease-out">
            <img src="{{ asset('assets/GELIA_LOGO.webp') }}"
                alt="Logotipo G.E.L.I.A."
                class="h-28 md:h-36 w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
        </div>

        <!-- Título actualizado -->
        <h1 class="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
            Bienvenido a <span class="text-transparent bg-clip-text bg-gradient-to-r from-woocommerce-main to-aromas-main">G.E.L.I.A.</span>
        </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
        ...
        <a href="{{ route('gelia.index') }}" class="group relative bg-dark-800 rounded-2xl p-10 border border-dark-700 hover:border-aromas-main/50 transition-all duration-300 hover:shadow-2xl hover:shadow-aromas-main/10 overflow-hidden flex flex-col items-center text-center">
            ...
            <!-- Modificación en la sección "relative z-10" de Aromas -->
            <div class="relative z-10">
                <div class="w-32 h-32 mb-6 mx-auto bg-dark-900 rounded-full flex items-center justify-center border-4 border-dark-800 group-hover:border-aromas-main transition-colors shadow-inner overflow-hidden">
                    <img src="{{ asset('assets/aromas_exclusivos_logo_transparente.png') }}" alt="Logo Aromas" class="w-20 h-20 object-contain">
                </div>
        ...
        <a href="{{ route('bellaroma.index') }}" class="group relative bg-dark-800 rounded-2xl p-10 border border-dark-700 hover:border-bella-main/50 transition-all duration-300 hover:shadow-2xl hover:shadow-bella-main/10 overflow-hidden flex flex-col items-center text-center">
            ...
            <!-- Modificación en la sección "relative z-10" de Bellaroma -->
            <div class="relative z-10">
                <div class="w-32 h-32 mb-6 mx-auto bg-dark-900 rounded-full flex items-center justify-center border-4 border-dark-800 group-hover:border-bella-main transition-colors shadow-inner overflow-hidden">
                    <img src="{{ asset('assets/br_logo_lanco_transparente.png') }}" alt="Logo Bellaroma" class="w-20 h-20 object-contain">
                </div>
